...
from transformers.models.vit_mae.modeling_vit_mae import ViTMAEForSemanticSegmentation
...
class ModelArguments:
    ...
    model_type: str = field(
        default="vitmae",
        metadata={"help": "type of model (set to vitmea to use ViTMAEForSemanticSegmentation)"},
    )
