...
predict_result_path=/saves/taiyi_clip-vqa-base-finetuned_test/result_ch_clip.json
output_dir=/saves/taiyi_clip-vqa-base-finetuned_test
...
python $main \
	...
	--num_train_epochs="10" \
	--push_to_hub &> logs/taiyi_clip-vqa-base-finetuned_test.log
