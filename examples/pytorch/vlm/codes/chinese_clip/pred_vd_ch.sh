main=/codes/run_new_vd.py
model=/saves/chinese_clip-vd-base-finetuned/
output_dir=/saves/chinese_clip-vd-base-finetuned
cache=/tmp
...
predict_result_path=/saves/chinese_clip-vd-base-finetuned/result_ch_chinese.json
