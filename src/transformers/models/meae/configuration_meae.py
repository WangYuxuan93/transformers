...
class MEAEConfig(RobertaConfig):
    """
    This class overrides [`RobertaConfig`]. Please check the superclass for the appropriate documentation alongside
    usage examples. Instantiating a configuration with the defaults will yield a similar configuration to that of the
    XLMRoBERTa [xlm-roberta-base](https://huggingface.co/xlm-roberta-base) architecture.
    ...
    def __init__(
        ...
        entity_vocab_size = 1200002,
        entity_embed_dim = 256,
        entity_padding_idx = 1,
        mention_to_add_entity_embedding = "first",
        **kwargs
    ):
        """Constructs RobertaConfig."""
        super().__init__(**kwargs)
        self.entity_memory_after_layers = entity_memory_after_layers
        self.entity_vocab_size = entity_vocab_size
        self.entity_embed_dim = entity_embed_dim
        self.entity_padding_idx = entity_padding_idx
        mention_to_add_entity_embedding = mention_to_add_entity_embedding
